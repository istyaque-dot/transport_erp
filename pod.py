...
def show_pod_page():
    st.markdown("""
        <style>
            /* टॉप पैडिंग को थोड़ा बढ़ाकर बैलेंस किया (2.8rem), नीचे की खाली जगह भरने के लिए बॉटम पैडिंग दी */
            .block-container {
            ...
            /* बीच का गैप (Middle Space) मामूली सा और कम किया */
            ...
            hr { margin: 0.15em 0 !important; border-color: #ddd !important; }
            
            .stButton > button { min-height: 1.7rem !important; padding: 0 10px !important; font-size: 0.85rem !important; }
            
            /* नीचे की खाली जगह को कवर करने के लिए बॉक्स की पैडिंग हल्की सी बढ़ाई */
            .custom-box {
                background: #f8f9fa; border: 1px solid #d1d5db;
                border-radius: 6px; padding: 12px; height: 100%; margin-top: 0;
            }
            .balance-card-due {
