...
# ==========================================
def show_pod_page():
    # 🟢 PERFECT CSS: Top Margin Increased, Middle Space Slightly Reduced
    st.markdown("""
        <style>
            /* टॉप पैडिंग बढ़ाकर 3.5rem कर दी है ताकि हेडिंग टॉप बार से न चिपके/ओवरलैप न हो */
            .block-container { padding-top: 3.5rem !important; padding-bottom: 0.5rem !important; max-width: 98% !important; }
            ...
            /* बीच का गैप (Middle Space) मामूली सा कम किया है */
            ...
            .stSelectbox > div > div > select { 
                padding-top: 2px !important; padding-bottom: 2px !important; min-height: 1.7rem !important; font-size: 0.85rem !important;
            }
            
            label { font-size: 0.8rem !important; font-weight: 600 !important; margin-bottom: 0px !important; padding-bottom: 0px !important; }
            
            /* अलर्ट बॉक्स (पीला वाला) के ऊपर-नीचे का गैप बहुत हल्का सा कम किया */
            div[data-testid="stAlert"] { padding: 4px 10px !important; min-height: 28px !important; margin-top: 0.1rem !important; margin-bottom: 0.1rem !important;}
            ...
            hr { margin: 0.25em 0px !important; border-color: #ddd !important; }
            .stButton > button { min-height: 1.7rem !important; padding: 0px 10px !important; font-size: 0.85rem !important;}
