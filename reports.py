...
def show_reports_page():
    ...
    # --- TAB 3: 🟢 SINGLE TRIP PASSBOOK (WITH EDITABLE MUNSHIYANA & WHATSAPP) ---
    with tab3:
        ...
        if len(all_bk) > 1:
            ...
            if selected != "चुनें...":
                ...
                # Balance Calc (From Owner_PODs or Owner_Ledger check)
                ...
                # Balance ko negative sign se set karne ke liye
...
----------------------------"""
                ...
                st.info("💡 ऊपर दिए गए बॉक्स से टेक्स्ट कॉपी करके मालिक को भेज सकते हैं। (मुंशीयाना बदलने पर यह मैसेज अपने आप अपडेट हो जाएगा)")
        else:
